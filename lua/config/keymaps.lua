...
map("n", "<C-h>", "<cmd> TmuxNavigateLeft<Cr><CR>", opts)
map("n", "<C-l>", "<cmd> TmuxNavigateRight<Cr><CR>", opts)
map("n", "<C-j>", "<cmd> TmuxNavigateDown<Cr><CR>", opts)
map("n", "<C-k>", "<cmd> TmuxNavigateUp<Cr><CR>", opts)
